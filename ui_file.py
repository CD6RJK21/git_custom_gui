...
# Form implementation generated from reading ui file 'git_custom_gui_ui_realise_2.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(902, 651)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setEnabled(True)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(520, 0, 381, 591))
        ...
        self.label_console_manual.setStyleSheet("font: 8pt \"Lucida Console\";\n"
                                                "color: rgb(255, 255, 255);\n"
                                                "background-color: rgb(0, 0, 0);\n"
                                                "")
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(-1, 329, 521, 261))
        self.gridLayoutWidget_3.setObjectName("gridLayoutWidget_3")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.gridLayoutWidget_3)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.commitMessege = QtWidgets.QPlainTextEdit(self.gridLayoutWidget_3)
        self.commitMessege.setObjectName("commitMessege")
        self.gridLayout_3.addWidget(self.commitMessege, 1, 1, 1, 1)
        self.label_commit_messege = QtWidgets.QLabel(self.gridLayoutWidget_3)
        self.label_commit_messege.setObjectName("label_commit_messege")
        self.gridLayout_3.addWidget(self.label_commit_messege, 0, 1, 1, 1)
        self.commitButton = QtWidgets.QPushButton(self.gridLayoutWidget_3)
        self.commitButton.setMinimumSize(QtCore.QSize(0, 0))
        self.commitButton.setObjectName("commitButton")
        self.gridLayout_3.addWidget(self.commitButton, 0, 0, 1, 1, QtCore.Qt.AlignLeft)
        self.verticalLayout_3 = QtWidgets.QVBoxLayout()
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.commit_all = QtWidgets.QRadioButton(self.gridLayoutWidget_3)
        self.commit_all.setMinimumSize(QtCore.QSize(0, 0))
        self.commit_all.setChecked(True)
        self.commit_all.setObjectName("commit_all")
        self.verticalLayout_3.addWidget(self.commit_all, 0, QtCore.Qt.AlignTop)
        self.commit_one_file = QtWidgets.QRadioButton(self.gridLayoutWidget_3)
        ...
        self.verticalLayout_3.addWidget(self.commit_one_file, 0, QtCore.Qt.AlignTop)
        self.verticalLayout_4 = QtWidgets.QVBoxLayout()
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.label_commit_one_file = QtWidgets.QLabel(self.gridLayoutWidget_3)
        ...
        self.verticalLayout_4.addWidget(self.label_commit_one_file)
        self.commit_one_file_name = QtWidgets.QLineEdit(self.gridLayoutWidget_3)
        ...
        self.verticalLayout_4.addWidget(self.commit_one_file_name)
